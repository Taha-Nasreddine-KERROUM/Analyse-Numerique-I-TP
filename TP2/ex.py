import sys
sys.path.append('../TP1')
from tp import determinantIterative as det, lireMatrice as lireA, isTriangulaireSuprieure as triS, isTriangulaireInfrieure as triI
import time
